...
${FSLDIR}/bin/bet T1_roi.nii T1_brain.nii

#step5: registration from cut to MNI
${FSLDIR}/bin/flirt -in T1_brain.nii -ref $FSLDIR/data/standard/MNI152_T1_1mm_brain -out outvol -omat orig_to_MNI.mat

#step4: performing fast
${FSLDIR}/bin/fast -S 1 -t 1 -o segm -n 3 outvol.nii
